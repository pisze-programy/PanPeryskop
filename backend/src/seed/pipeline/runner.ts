...
import { buildDescription, dedupe, showtimesJson, showtimeBookingJson } from '../core/dedupe';
  ...
  for (const c of merged) {
    ...
    try {
      ...
      await doSavePost(
        ...
        mediaKey, thumbKey, createdAt, true, c.link, c.externalId, Boolean(existing), Boolean(c.isSoldOut), showtimesJson(c), showtimeBookingJson(c)
      );
