...
/// Small, non-interactive 3D city map centred on the event venue — gives the
/// event a place without opening a full map. City zoom (not street) so an
/// imprecise venue coordinate still looks right.
