...
extension APIClient {
    ...
    /// Places for one Wycieczki section (hotel / attraction / car / insurance)
    /// around the event coordinates.
    static func getTravelPlaces(kind: PlaceKind, lat: Double, lng: Double) async throws -> TravelPlacesResponse {
